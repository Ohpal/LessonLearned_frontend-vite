...
const _hoisted_2 = { class: "col-md-6 mb-3" };
const _hoisted_3 = {
  key: 0,
  class: "text-danger"
};
...
const _hoisted_18 = { class: "text-secondary ms-2" };
const _hoisted_19 = { class: "d-flex justify-content-end gap-2 mt-4" };
const _hoisted_20 = { class: "toast-container position-fixed top-50 start-50 translate-middle p-3" };
const _hoisted_21 = {
  key: 0,
...
const _hoisted_23 = { class: "toast-body" };
      ...
      return _openBlock(), _createElementBlock("form", {
        ...
        _createElementVNode("div", _hoisted_1, [
          _createElementVNode("div", _hoisted_2, [
            ...
            errors.value.error_title ? (_openBlock(), _createElementBlock("small", _hoisted_3, _toDisplayString(" ※프로젝트 명을 입력하세요."))) : _createCommentVNode("", true),
          ...
          _createElementVNode("div", _hoisted_4, [
            ...
            errors.value.error_date ? (_openBlock(), _createElementBlock("small", _hoisted_5, _toDisplayString(" ※날짜를 선택하세요."))) : _createCommentVNode("", true),
            _withDirectives(_createElementVNode("input", {
              type: "date",
          ...
          _createElementVNode("div", _hoisted_7, [
            ...
            errors.value.error_department ? (_openBlock(), _createElementBlock("small", _hoisted_8, _toDisplayString(" ※관련 부서를 입력하세요."))) : _createCommentVNode("", true),
            _withDirectives(_createElementVNode("input", {
              type: "text",
              autocomplete: "off",
          ...
          _createElementVNode("div", _hoisted_9, [
            ...
            errors.value.error_commander ? (_openBlock(), _createElementBlock("small", _hoisted_10, _toDisplayString(" ※성함을 입력하세요."))) : _createCommentVNode("", true),
            _withDirectives(_createElementVNode("input", {
              type: "text",
              autocomplete: "off",
          ...
          _createElementVNode("div", _hoisted_11, [
            ...
            errors.value.error_part ? (_openBlock(), _createElementBlock("small", _hoisted_12, _toDisplayString(" ※시운전 파트를 선택하세요."))) : _createCommentVNode("", true),
            _withDirectives(_createElementVNode("select", {
              ...
              _createStaticVNode('<option value="" data-v-318561e1>관련 시운전파트</option><option value="general" data-v-318561e1>General Part</option><option value="hull" data-v-318561e1>HULL Part</option><option value="machinery" data-v-318561e1>Machinery Part</option><option value="electric" data-v-318561e1>Electric Part</option><option value="accommodation" data-v-318561e1>Accomodation Part</option><option value="outfitting" data-v-318561e1>Outfitting Part</option>', 7)
            ]), 2), [
          ...
          _createElementVNode("div", _hoisted_13, [
            ...
            errors.value.error_description ? (_openBlock(), _createElementBlock("small", _hoisted_14, _toDisplayString(" ※시운전 항목을 입력하세요."))) : _createCommentVNode("", true),
            _withDirectives(_createElementVNode("input", {
              type: "text",
              autocomplete: "off",
        ...
        _createElementVNode("div", _hoisted_17, [
          ...
          _createElementVNode("small", _hoisted_18, _toDisplayString(fileName.value), 1)
        ]),
        ...
        _createElementVNode("div", _hoisted_20, [
          show.value ? (_openBlock(), _createElementBlock("div", _hoisted_21, [
            _createElementVNode("div", _hoisted_22, [
              ...
              _createElementVNode("div", _hoisted_23, _toDisplayString(message.value), 1)
            ])
...
const WriteLessonlearned = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-318561e1"]]);
export {
